...
$attendanceTime[]= $_POST['startTime'];
$attendanceTime[] = $_POST['finishTime'];
    ...
    <form class="" action="schedule_register.php" method="post">
      ...
      <table class="none">
        ...
        <td>
          ...
          <input type="hidden" name="finishTime" value="<?php echo $_POST['finishTime']; ?>">
          <button class="submit" type="submit" name="copy">複製</button>
        </td>
      </table>
    </form>
  </div>
